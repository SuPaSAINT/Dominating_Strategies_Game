...
GAME_COST_MATRIX_1 = GameBuild(num_cyber_nodes,RESOURCE_MATRIX_ARRAY_1,CONNECTIONS,COST,threshold);
GAME_COST_MATRIX_2 = GameBuild(num_cyber_nodes,RESOURCE_MATRIX_ARRAY_2,CONNECTIONS,COST,threshold);
GAME_COST_MATRIX_3 = GameBuild(num_cyber_nodes,RESOURCE_MATRIX_ARRAY_3,CONNECTIONS,COST,threshold);
...
% BUILD THE 3-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
REDUCED_GAME_COST_MATRIX_1 = GameBuild2(num_cyber_nodes,REDUCED_RESOURCE_MATRIX_ARRAY_1,CONNECTIONS,COST,threshold);
...
[Aa_1,payoff_1,iterations_1,err_1] = NPG2(num_of_strat_1,REDUCED_GAME_COST_MATRIX_1);
...
% BUILD THE 3-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
REDUCED_GAME_COST_MATRIX_2 = GameBuild2(num_cyber_nodes,REDUCED_RESOURCE_MATRIX_ARRAY_2,CONNECTIONS,COST,threshold);
...
% EXECUTE THE GAME CALCULATION
[Aa_2,payoff_2,iterations_2,err_2] = NPG2(num_of_strat_2,REDUCED_GAME_COST_MATRIX_2);
...
% BUILD THE 3-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
REDUCED_GAME_COST_MATRIX_3 = GameBuild2(num_cyber_nodes,REDUCED_RESOURCE_MATRIX_ARRAY_3,CONNECTIONS,COST,threshold);
...
% EXECUTE THE GAME CALCULATION
[Aa_3,payoff_3,iterations_3,err_3] = NPG2(num_of_strat_3,REDUCED_GAME_COST_MATRIX_3);
